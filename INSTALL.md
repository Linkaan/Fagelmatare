...
```bash
dd if="~/piCore-8.0.img" of="/dev/sdx"
sync
```
...
Once you're logged in we need to partion our SD card to add persistent storage. We need this to install our software. We want to expand the mmcblk0p2 partition to fill our SD card.
