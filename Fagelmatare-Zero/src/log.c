...
void log_info(const char *format, ...) {
  ...
  time(rawtime);
  log_msg(LOG_LEVEL_INFO, rawtime, "Pi Zero", format, args);
  va_end(args);
}
...
void log_warn(const char *format, ...) {
  ...
  rawtime = malloc(sizeof(time_t));
  time(rawtime);
  log_msg(LOG_LEVEL_WARN, rawtime, "Pi Zero", format, args);
  va_end(args);
}
...
void log_error(const char *format, ...) {
  ...
  rawtime = malloc(sizeof(time_t));
  time(rawtime);
  log_msg(LOG_LEVEL_ERROR, rawtime, "Pi Zero", format, args);
  va_end(args);
}
...
void log_fatal(const char *format, ...) {
  ...
  rawtime = malloc(sizeof(time_t));
  time(rawtime);
  log_msg(LOG_LEVEL_FATAL, rawtime, "Pi Zero", format, args);
  va_end(args);
}
